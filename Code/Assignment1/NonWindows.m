...
%%
%{
Program version compatible with non windows machines.
Takes aproximatelly 15 minutes to run
%}
%% PROBLEM DATA
...
% Compute
DV = findFlyby(firstLaunchDate, lastLaunchDate, timeStep, flybyWindow, interceptWindow);
...
[DVoptimal,optDepDV,optIntDV,optGraDV,optFlyDV,mjd2000,departureV,flybyDepartureV,VinfplusVec,VinfminusVec,rpFlyby,delta,VPminus,VPplus] = findFlyby(firstLaunchDateOptimal, lastLaunchDateOptimal, timestepOptimal, flybyWindow, interceptWindow);
